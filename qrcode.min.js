/**
 * QRCode.js v1.0.0 (Compact Standalone Edition)
 * Pure JavaScript QR Code generator for offline & canvas rendering
 */
(function(root, factory) {
    ...
    QRCode.prototype._draw = function() {
        ...
        var nMargin = Math.floor((this._htOption.width - nWidth * nCount) / 2);
        ...
        for (var row = 0; row < nCount; row++) {
            for (var col = 0; col < nCount; col++) {
                if (this._oQRCode.isDark(row, col)) {
                    ctx.fillRect(nMargin + col * nWidth, nMargin + row * nHeight, nWidth, nHeight);
                }
            }
        }
